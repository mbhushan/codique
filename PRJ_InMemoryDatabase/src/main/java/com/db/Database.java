...
public class Database<T> {
	...
	public boolean checkTableMap(T name) {
		return this.tableMap.containsKey(name);
	}
	
	public boolean checkvalueCountMap(T value) {
		return this.valueCountMap.containsKey(value);
	}
